...
import OrderDetail from "../../components/adminproduct/OrderDetail";
import UserDetail from "../../components/adminproduct/UserDetail";
        ...
        <div className="mid mb-5">
          ...
          <div className=" bg-blue-50 py-5 rounded-xl border border-blue-100">
            ...
            <div className="flex justify-center">
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmF5QAG7nLHwWs9LmdCfQfUY7oOsUu3d0Zp4W7x-524Q&s"
                alt=""
              />
            </div>
