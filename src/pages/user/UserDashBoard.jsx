                ...
                <div className="top ">
                    ...
                    <div className=" bg-blue-50 py-5 rounded-xl border border-blue-100">
                        ...
                        <div className="flex justify-center">
                            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQmF5QAG7nLHwWs9LmdCfQfUY7oOsUu3d0Zp4W7x-524Q&s" alt="" />
                        </div>
                        {/* text  */}
                        <div className="">
                            <h1 className=" text-center text-lg">
                                ...
                                {/* ?. operator is used for optional chaining. It allows you to access properties or methods of an object if that object is not null or undefined. If the object is null or undefined, the expression will short-circuit and return undefined, preventing an error from occurring. */}
                            <h1 className=" text-center text-lg"><span className=" font-bold">Email: </span>
                            {user?.email}</h1>
                           ...
                           <h1 className=" text-center text-lg"><span className=" font-bold">Date: </span>
                            ...
                            {/* Role */}
                            <h1 className=" text-center text-lg"><span className=" font-bold">Role: </span>
                            {user?.role}</h1>
                        </div>
                    </div>
                </div>
